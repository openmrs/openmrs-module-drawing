...
(function() {
    ...
    function PaintHandler(el, event, options) {
        ...
        var _this = this, plugin = this.getPlugin();
    ...
    PaintHandler.prototype.snapToGrid = function(draw) {
        ...
        for ( var i in draw) {
            ...
            draw[i] -= (temp < this.options.snapToGrid / 2 ? temp : temp - this.options.snapToGrid)
    ...
    SVG.Element.prototype.draw.extend('line polyline polygon', {
        ...
        init : function(e) {
            ...
            var p = this.startPoint, arr = [ [ p.x, p.y ], [ p.x, p.y ] ];
        ...
        point : function(e) {
            ...
            if (this.el.type.indexOf('poly') > -1) {
                ...
                var p = this.transformPoint(e.clientX, e.clientY), arr = this.el.array().valueOf();
        ...
        drawCircles : function() {
            ...
            for (var i = 0; i < array.length; ++i) {
                ...
                var p = this.p.matrixTransform(this.parent.node.getScreenCTM().inverse().multiply(
                        this.el.node.getScreenCTM()));
    ...
    SVG.Element.prototype.draw.extend('circle', {
        ...
        calc : function(e) {
            ...
            var p = this.transformPoint(e.clientX, e.clientY), circle = {
                cx : this.startPoint.x,
                cy : this.startPoint.y,

                // calculating the radius
                r : Math.sqrt((p.x - this.startPoint.x) * (p.x - this.startPoint.x) + (p.y - this.startPoint.y)
